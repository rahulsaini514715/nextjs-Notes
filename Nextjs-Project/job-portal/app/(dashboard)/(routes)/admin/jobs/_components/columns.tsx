...
export const columns: ColumnDef<JobsColumns>[] = [
  ...
  },
  {
    ...
    cell : ({row})=>{
        ...
        return(
            <div className={cn("border px-2 py-1 text-xs rounded-md w-24 text-center", isPusblished ? "border-emerald-500 bg-emerald-100/80" : "border-red-500 bg-red-100/80")}>
                {isPusblished ? "Published" : "Unpublished"}
            </div>
        )
    }
  },
